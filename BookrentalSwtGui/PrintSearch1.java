...
public class PrintSearch1 {

        private Table table;

        public void open1(final String s, final Display display) {
                ...
                table.addListener(SWT.SetData, new Listener() {
                    public void handleEvent(Event event) {
                        ...
                        try {
                            ...
                            PreparedStatement ps = con.prepareStatement("select * from addbook  where authorname =?");
            ...
            button1.addSelectionListener(new SelectionAdapter() {
                public void widgetSelected (SelectionEvent e){
                    ...
                    try {
                        ...
                        DeleteBook1 deleteBook1 = new DeleteBook1();
                        deleteBook1.DleteBook1(authorname,display);
                    } catch (Exception a) {
                    }
