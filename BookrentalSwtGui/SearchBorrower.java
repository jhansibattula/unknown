...
public class SearchBorrower {
    ...
    public SearchBorrower(final Display display) {


   // Display d = Display.getDefault();
            final Shell shell = new Shell();
            shell.setSize(600, 600);
            shell.setText("Searching The Customer Details In Borrow List");
                ...
                if (verifyEvent.text.isEmpty()) {
                    ...
                    for (int i = 0; i < verifyEvent.text.length(); i++) {
                        ...
                        if (!allow) {
                            ...
                            dialougue.setMessage("please enter the letters");
                            dialougue.open();
                            break;
                        }
                    }
        ...
        button.addSelectionListener(new SelectionAdapter() {
                public void widgetSelected(SelectionEvent e) {
                    ...
                    try {
                        ...
                        PrintBorrower J = new PrintBorrower();
                        J.openBorrower(firstname,display);
                        shell.dispose();
