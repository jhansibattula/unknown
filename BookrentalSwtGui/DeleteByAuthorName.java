...
public class DeleteByAuthorName {


   // public SearchByAuthorname(final Display display) {


    public DeleteByAuthorName(final Display display) {
    ...
    // Display d = Display.getDefault();
        ...
        button.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent e) {
                System.out.println(e.getSource() + "Button search was clicked");
                try {
                    //shell.dispose();

                    String authorname = text.getText();
                    PrintSearch1 J = new PrintSearch1();
                    J.open1(authorname,display);
